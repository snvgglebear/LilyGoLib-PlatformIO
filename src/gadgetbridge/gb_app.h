 ...
 * through the accessors, which keeps the screen code out of the protocol and
 * makes the app testable from the emulator build.
 */
#pragma once
...
/// The one instance, shared by the entry points and the UI.
extern GbApp gb_app;

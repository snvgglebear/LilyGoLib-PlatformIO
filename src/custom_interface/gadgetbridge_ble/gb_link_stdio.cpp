 ...
 *
 * Ported unchanged from src/gadgetbridge/gb_link_stdio.cpp -- gb_link.h and
 * gb_protocol.h (GbLineAssembler, gb_protocol_dispatch) are identical here.
 */
#ifndef ARDUINO
...
{
    return "T-Watch Ultra (custom_interface emulator)";
}
